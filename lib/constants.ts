export const GROUP_DEFAULT_TIMES: Record<string, { start: string; end: string }> = {
  ...
  hach:     { start: '08:00', end: '00:00' },
  stefan:   { start: '07:00', end: '20:00' },
  kasjutin: { start: '07:00', end: '20:00' },
};

// Quick-add config: times and whether to auto-create a 00:00–<start> tail on the next day
export const GROUP_QUICK_CONFIG: Record<string, { start: string; end: string; nextDayTail: boolean }> = {
  ...
  hach:     { start: '08:00', end: '00:00', nextDayTail: true },
...
export function getGroupQuickConfig(groupName: string) {
  ...
  return key ? GROUP_QUICK_CONFIG[key] : { start: '07:00', end: '20:00', nextDayTail: false };
}
...
export const germanHolidays = [
  ...
  '2026-01-01','2026-04-03','2026-04-06','2026-05-01','2026-05-14','2026-05-25','2026-06-04','2026-10-03','2026-11-01','2026-12-25','2026-12-26',
];
